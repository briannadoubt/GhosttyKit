...
```swift
.package(url: "https://github.com/briannadoubt/GhosttyKit.git", from: "0.1.0")
```
...
The script rebuilds `GhosttyKit.xcframework`, syncs the public headers, and
records the exact upstream commit in `Vendor/libghostty.version`.
